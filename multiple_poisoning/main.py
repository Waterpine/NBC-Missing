...
def multiple_poisoning_process(num_points, mv_prob, dataset, data_dir):
    ...
    print(run_time, 's')
    with open(filename, 'a') as file:
        file.write("========== Multiple Greedy Search Poisoning (GS) ==========" + "\n")
        file.write("steps: " + str(step) + '\n')
        file.write("poisoning_rate: " + str(step / train_size) + '\n')
        file.write("total_run_time: " + str(run_time) + '\n')
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--num_points', default=16)
